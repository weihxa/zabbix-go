...
import "github.com/weihxa/zabbix-go/common"

type Client struct {
	common.Client
}

func NewClient(credential *common.Client) (client *Client, err error) {
	client = &Client{}
	client.URL = credential.URL
	client.Token = credential.Token
	client.APIVersion = credential.APIVersion
	return
}
...
type HostGetParams struct {
	...
	SelectGroups common.SelectQuery `json:"selectGroups,omitempty"`

	// SelectApplications causes the Applications from each Host to be attached
	// in the search results.
	SelectApplications common.SelectQuery `json:"selectApplications,omitempty"`

	// SelectDiscoveries causes the Low-Level Discoveries from each Host to be
	// attached in the search results.
	SelectDiscoveries common.SelectQuery `json:"selectDiscoveries,omitempty"`

	// SelectDiscoveryRule causes the Low-Level Discovery Rule that created each
	// Host to be attached in the search results.
	SelectDiscoveryRule common.SelectQuery `json:"selectDiscoveryRule,omitempty"`

	// SelectGraphs causes the Graphs from each Host to be attached in the
	// search results.
	SelectGraphs common.SelectQuery `json:"selectGraphs,omitempty"`

	SelectHostDiscovery common.SelectQuery `json:"selectHostDiscovery,omitempty"`

	SelectWebScenarios common.SelectQuery `json:"selectHttpTests,omitempty"`

	SelectInterfaces common.SelectQuery `json:"selectInterfaces,omitempty"`

	SelectInventory common.SelectQuery `json:"selectInventory,omitempty"`

	SelectItems common.SelectQuery `json:"selectItems,omitempty"`

	SelectMacros common.SelectQuery `json:"selectMacros,omitempty"`

	SelectParentTemplates common.SelectQuery `json:"selectParentTemplates,omitempty"`
	SelectScreens         common.SelectQuery `json:"selectScreens,omitempty"`
	SelectTriggers        common.SelectQuery `json:"selectTriggers,omitempty"`
}
...
func (c *Client) GetHosts(params HostGetParams) ([]Host, error) {
	hosts := make([]Host, 0)
