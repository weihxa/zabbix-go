...
type HostgroupGetParams struct {
	...
	SelectGroupDiscovery common.SelectQuery `json:"selectGroupDiscovery,omitempty"`

	// Return the hosts that belong to the host group in the hosts property
	SelectHosts common.SelectQuery `json:"selectHosts,omitempty"`

	// Return the templates that belong to the host group in the templates property
	SelectTemplates common.SelectQuery `json:"selectTemplates,omitempty"`
...
func (c *Client) GetHostgroups(params HostgroupGetParams) ([]Hostgroup, error) {
